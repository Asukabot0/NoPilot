...
This copies prompt files, JSON schemas, and `workflow.json` into your project, and appends Lash auto-trigger context to your `CLAUDE.md`.
...
```
your-project/
├── .claude/commands/        # Slash commands (created by nopilot init)
...
│   ├── lash-build.md        # Lash orchestration prompts
│   ├── lash-tracer.md
│   ├── lash-batch.md
│   ├── lash-verify.md
│   └── ...                  # + 3 more Lash prompts
