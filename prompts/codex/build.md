...
After the tests artifact is generated, spawn a fresh Codex Critic sub-agent using `~/.codex/prompts/critic.md` for independent test quality review. The build agent must NEVER evaluate its own test output.
...
Spawn a fresh Codex Critic sub-agent using `~/.codex/prompts/critic.md` for independent acceptance validation:
...
- Spawn a fresh Codex Supervisor sub-agent using `~/.codex/prompts/supervisor.md`
