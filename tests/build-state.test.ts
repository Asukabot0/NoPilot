...
import type { BuildState, BuildEvent, BuildPhase, ExecutionPlan } from '../src/lash/types.js';
...
describe('initializeBatches', () => {
  ...
  it('sets current_phase to batch_execution and updates timestamp', () => {
    const state = makeBaseState();
    ...
    expect(result.current_phase).toBe('batch_execution');
